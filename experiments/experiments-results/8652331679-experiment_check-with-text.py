...
best_learner = selector['learner_stats'].reset_index()['learner_id'][0]

best_learner

{"learning_rate": 0.3, "max_depth": 10, "min_child_weight": 0.01, "n_estimators": 100, "n_jobs": 4, "scale_pos_weight": 1}

df = data.query(f'learner_id == {best_learner}').query('fold == "2017-12-26"')
...
get_feature_importance_distribution_for_learner(features, list(learner_ids)[0], top=100)
