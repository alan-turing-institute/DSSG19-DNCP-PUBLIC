...
macro_experiment_id = 6996804136
...
#                     dashes=['higher_than_x'],
                    data=data.query('type_procurement == "director3"').query('metric == "recall"'), ax=axis)
...
get_feature_importance_distribution_for_learner(features, list(learner_ids)[0], top=20)
